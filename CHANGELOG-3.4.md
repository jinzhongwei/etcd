...
- Move internal packages to `etcdserver`.
  - `"github.com/coreos/etcd/alarm"` to `"etcd/etcdserver/api/v3alarm"`.
  - `"github.com/coreos/etcd/compactor"` to `"etcd/etcdserver/api/v3compactor"`.
  - `"github.com/coreos/etcd/discovery"` to `"etcd/etcdserver/api/v2discovery"`.
  - `"github.com/coreos/etcd/etcdserver/auth"` to `"etcd/etcdserver/api/v2auth"`.
  - `"github.com/coreos/etcd/etcdserver/membership"` to `"etcd/etcdserver/api/membership"`.
  - `"github.com/coreos/etcd/etcdserver/stats"` to `"etcd/etcdserver/api/v2stats"`.
  - `"github.com/coreos/etcd/error"` to `"etcd/etcdserver/api/v2error"`.
  - `"github.com/coreos/etcd/rafthttp"` to `"etcd/etcdserver/api/rafthttp"`.
  - `"github.com/coreos/etcd/snap"` to `"etcd/etcdserver/api/snap"`.
  - `"github.com/coreos/etcd/store"` to `"etcd/etcdserver/api/v2store"`.
